...
# чтобы не зависеть от того, попадает ли товар в «плохую» категорию или нет
# (на случай ошибочной классификации поставщика).
NON_RETAIL_Q = Q(title__iregex=(
    r'^\s*(кронштей|чехл|пульт|фильтр|насадк|инструмент|переходник|удлинител|'
    r'клапан|переключател|сальник|трубк|запчаст|аксессуар|комплектующ|'
    r'расходн|абажур|штатив|зарядн)'
))
