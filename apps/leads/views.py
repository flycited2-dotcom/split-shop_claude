...
# Пилюли шага 1: (значение area_sqm, площадь, мощность). Площадь и BTU — двумя
# строками, а не одной подписью в скобках: на мобильном одна строка «более 65 м²
# (30 000 BTU)» переносилась, соседние нет — плитки выходили разной высоты.
# BTU считается на сервере через quiz_logic.btu_candidates() — на границах
# автоматически добавится secondary.
AREA_OPTIONS = [
